...
public class HomeWork2 {
	public static void main(String[] args) {
		...
		//When ever a user done with payments program should 
		...
		System.out.println("Pls enter you wanna buy");
		String item = scan.nextLine();
		System.out.println("Pls enter the price");
		double price = scan.nextDouble();
		
		do {
			System.out.println("Pls give me the payment");
			money = scan.nextDouble();
			totalAmount+=money;
			if(totalAmount<price) {
				remainingBalance=price-totalAmount;
				System.out.println("Give me more money "+remainingBalance);
			}else if(totalAmount>price) {
				change=totalAmount-price;
				System.out.println("Your change is "+change);
			}else {
				System.out.println("you gave exactly what you owed me");
			}
